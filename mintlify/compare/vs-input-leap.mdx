---
title: "ShareClick vs Input Leap"
description: "A free, open-source Input Leap alternative: encrypted by default, clipboard images, file transfer and mDNS discovery for Mac and Windows."
icon: "scale-balanced"
---
...
Input Leap (and Barrier before it) proved how useful a software KVM is.
ShareClick is the newer, security-first take focused on Mac↔Windows: a UDP input
path (~6 µs transport overhead), encryption on every channel, clipboard images,
file transfer, and mDNS discovery.
